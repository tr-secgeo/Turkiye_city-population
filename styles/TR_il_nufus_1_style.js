...
var style_TR_il_nufus_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("nufus");
    var labelText = "";
    size = 0;
    ...
    if (value >= 86047.000000 && value <= 278335.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 278335.000000 && value <= 409865.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 409865.000000 && value <= 647205.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 647205.000000 && value <= 1273519.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1273519.000000 && value <= 15655924.000000) {
            style = [ new ol.style.Style({
